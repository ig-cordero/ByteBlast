...
var poderUno = ['abajo','atras','patada']
signal poder1()
...
func _ready():
	$"../TiempoCombo".start(1)
	print("player 1 stats =" + str(Global.player1)+str(Global.index_player1)  )
	print("player 2 stats =" + str(Global.player2)+str(Global.index_player2)  )
	pass # Replace with function body.


func _process(delta):
	$"../CharacterBody2D/Label".text = str(Global.player1 , Global.index_player1)
	if Global.player1 == 1 and Global.index_player1 == 1:
		emit_signal("controladoractivoplayer1")
	elif Global.player2 == 2 and Global.index_player1 == 1:
